    ...
    <br>
       <div class="banner">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2>Acceso a cursos online</h2><br>
                </div>
               <div class="col-lg-8">
                         ...
                         <!-- Split button -->
                           <div class="btn-group">
                             <button type="button" class="btn btn-danger btn-lg  dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 <span class="glyphicon glyphicon-play" ></span> Transmiciones <span class="caret"></span>
                                </button>
                             <ul class="dropdown-menu">
                                <li class="dropdown-header"><b>Lista de profesores</b></li>
                               <li><a href="endirecto.php">Profesor Charles Xavier</a></li>
                               <li><a href="#">Profesor Stephen Hawking</a></li>                               
                               <li><a href="#">Dr. Bruce Banner</a></li>
                               <li><a href="#">Dr. Stephen Strange</a></li>
                         ...
                         <li>
                          <div class="btn-group">
                             <button type="button" class="btn btn-primary btn-lg  dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 <span class="glyphicon glyphicon-blackboard" aria-hidden="true"></span> Catalogo cursos <span class="caret"></span>
                                </button>
                             <ul class="dropdown-menu">
                                <li class="dropdown-header"><b>Lista de profesores</b></li>
                               <li><a href="cursos.php">Profesor Charles Xavier</a></li>
                               <li><a href="#">Dr. Stephen Strange</a></li>
                               <li><a href="#">Dr. Bruce Banner</a></li>
